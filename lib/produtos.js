...
/**
 * Mapeia linha `produtos` para o painel admin.
 * Diferente da vitrine (`mapProdutosRowToCatalog`): aceita preço zero e linha sem imagem.
 * @param {Record<string, unknown>} row
 */
...
export const PRODUTOS_CATALOG_SELECT =
  "id, olist_id, descricao, descricao_complementar, situacao, sku, gtin, tipo, unidade, tipo_variacao, data_criacao, data_alteracao, precos, estoque, anexos, seo, is_featured";
