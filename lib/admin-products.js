...
function resolveProductLookupId(productId) {
...
export async function getAdminProductById(productId) {
  ...
  try {
    ...
    throw new AdminProductsError("Não foi possível carregar detalhes do produto.", { status: 500, cause: error });
  }
}
...
export async function getAdminProductModalDetails(productId) {
  ...
  if (error) {
    ...
    throw new AdminProductsError("Não foi possível buscar produto.", { status: 500, cause: error });
  }
...
export async function deleteAdminProduct(productId) {
  ...
  if (fetchError) {
    ...
    if (isSchemaMismatchError(fetchError)) {
      throwProdutosSchemaMismatch();
    }
    throw new AdminProductsError("Não foi possível verificar o produto.", { status: 500, cause: fetchError });
  }
  ...
  if (deleteError) {
    ...
    if (isSchemaMismatchError(deleteError)) {
      throwProdutosSchemaMismatch();
    }
    throw new AdminProductsError("Não foi possível excluir o produto.", { status: 500, cause: deleteError });
  }
